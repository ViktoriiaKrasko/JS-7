...
function createAndCompareTwoSymbols(value) {
  return Symbol(value) === Symbol(value); // Створюємо два символи з однаковим описом value, та повертаємо результат порівняння двох символів
}
...
function useSymbolToStringTag() {
  ...
  myObject[Symbol.toString] = "CustomObject"; // Встановлюємо властивість Symbol об'єкту myObject на значення "CustomObject".
